...
ens=(
    ...
    # "E.44.112" "0.00044"   "4.3100e-4"  "0.012"  "0.13000" "0.14000" "0.15000"       "1.1759e-02"  "E112lsc/ave/data"  "end_line"
)
prefixs=("mix_fixed")
...
for ((ie = 0; ie < ${#ens[@]}; ie += $cols)); do
    ...
    for ((ic = 0; ic < ${#contrs_in[@]}; ic++)); do
        ...
        for ((it = 0; it < ${#eqop[@]}; it++)); do
            ...
            julia convert_sanfo_gm2.jl ${dir}/${ens[ie + 8]}/_l1_s_${TMOS[$(((it)))]}_${contrs_in[ic]} ${dirout}/c${ens[ie]}_r.${eqop[it]}_mu.${ens[ie + 2]}_mu.${ens[ie + 7]}_${contrs_out[ic]}.txt
            julia convert_sanfo_gm2.jl ${dir}/${ens[ie + 8]}/_l2_s_${TMOS[$(((it)))]}_${contrs_in[ic]} ${dirout}/c${ens[ie]}_r.${eqop[it]}_mu.${ens[ie + 1]}_mu.${ens[ie + 7]}_${contrs_out[ic]}.txt
...
########################### C80
ens=(
    # "C.06.80" "0.0005850" "0.00060" "0.014" "0.18000" "0.19000" "there is no 3rd charm" "1.6000e-02" "1.7000e-02" "C80lsc/ave/data" "end_line"
    "B.72.64" "0.0006675" "0.00072" "0.014" "0.23000" "0.24000" "there is no 3rd charm" "1.7500e-02" "1.8500e-02" "B64lsc/ave/data" "end_line"
