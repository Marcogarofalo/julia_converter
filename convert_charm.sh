...
########################### C80
ens=(
     "C.06.80"  "0.00060"   "0.013"  "0.014"  "0.18000" "0.19000" "there is no 3rd charm"       "-1.6000e-02"  "C80lsc/ave/data"  "1" "end_line"   
     "C.06.80"  "0.00060"   "0.013"  "0.014"  "0.18000" "0.19000" "there is no 3rd charm"       "-1.7000e-02"  "C80lsc/ave/data"  "2" "end_line"   
)   
prefixs=("mix_fixed"  )
...
for ((it = 0; it < ${#eqop[@]}; it++)); do
    ...
    julia convert_sanfo_gm2.jl ${dir}/${ens[ie+8]}/_s${ens[ie+9]}_c1_${TMOS[$(((it)))]}_${contrs_in[ic]}  ${dirout}/c${ens[ie]}_r.${eqop[it]}_mu.${ens[ie+7]}_mu.${ens[ie+4]}_${contrs_out[ic]}.txt
    julia convert_sanfo_gm2.jl ${dir}/${ens[ie+8]}/_s${ens[ie+9]}_c2_${TMOS[$(((it)))]}_${contrs_in[ic]}  ${dirout}/c${ens[ie]}_r.${eqop[it]}_mu.${ens[ie+7]}_mu.${ens[ie+5]}_${contrs_out[ic]}.txt
    # julia convert_sanfo_gm2.jl ${dir}/${ens[ie+8]}/_s_c3_${TMOS[$(((it)))]}_${contrs_in[ic]}  ${dirout}/c${ens[ie]}_r.${eqop[it]}_mu.${ens[ie+7]}_mu.${ens[ie+6]}_${contrs_out[ic]}.txt
