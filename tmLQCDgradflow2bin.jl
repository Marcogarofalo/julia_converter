...
function load_input(in)
	...
	masses = Base.invokelatest(isdefined, @__MODULE__, :masses) ? Base.invokelatest(getfield, @__MODULE__, :masses) : error("masses not defined in input file")
	...
	pattern_after_rep = Base.invokelatest(isdefined, @__MODULE__, :pattern_after_rep) ? Base.invokelatest(getfield, @__MODULE__, :pattern_after_rep) : "/"
